...
public class App {
	...
	while (true) {
		...
		case "8":
		    ...
		    System.out.println("Verificando equivalência entre estado " + primeiro + " e " + segundo + ":");
		    System.out.println(sistema.verificarEquivalencia(primeiro, segundo) + "\n");
		    holdOn();
		    break;
		...
		case "9":
		    ...
		    System.out.println("Verificando ordem parcial entre estado " + umEstado + " e " + outroEstado + ":");
		    System.out.println(sistema.verificarOrdemParcial(umEstado, outroEstado) + "\n");
		    holdOn();
		    break;
		...
		case "A":
		    ...
		    System.out.println("Fecho transitivo do estado " + estado + ":");
		...
		case "E":
		    ...
		    System.out.println("Verificando se há caminho de FFF para TTT:");
     ...
     *
     * @param mensagem Mensagem a ser exibida antes de ser pedido uma entrada.
     * @return Uma String com a entrada do usuário.
     */
